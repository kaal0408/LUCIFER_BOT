...
#Import Gudz
RUN wget https://raw.githubusercontent.com/kaal0408/LUCIFER_BOT/master/lightningrun.py
RUN wget https://raw.githubusercontent.com/kaal0408/LUCIFER_BOT/master/requirements.txt
#Start Fumkin
